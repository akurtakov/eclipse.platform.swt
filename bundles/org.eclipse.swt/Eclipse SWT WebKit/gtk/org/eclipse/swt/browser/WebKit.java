...
public void create (Composite parent, int style) {
	...
	if (FirstCreate) {
		...
		long context = WebKitGTK.webkit_web_context_get_default();
		// Note: WebKitGTK's bubblewrap sandbox can cause crashes in complex process
		// trees like Eclipse on GTK4, where the sandbox cannot properly access /proc
		// and display sockets. If you experience crashes, set the environment variable
		// WEBKIT_DISABLE_SANDBOX_THIS_IS_DANGEROUS=1 before starting Eclipse.
